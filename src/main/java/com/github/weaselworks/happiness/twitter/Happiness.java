...
public class Happiness extends Verticle {
    ...
    public void start() {
        ...
        //getContainer().deployVerticle("com.github.weaselworks.happiness.twitter.Choropleth");
        getContainer().deployVerticle("com.github.weaselworks.happiness.twitter.Globe");
